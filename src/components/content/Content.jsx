...
export default function Content(props) {
  ...
  return (
    <div className=" mt-12">
      <div className="text-sm text-stone-700 font-['JalnanGothic']  flex"><span>{props.category}</span><button type="button" onClick={(e)=> dispatch({ type: 'close', num: props.num })}  className="ml-5"><IoClose /></button></div>
